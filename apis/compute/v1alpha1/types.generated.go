...
// +kcc:proto=google.cloud.compute.v1beta.Interconnect
type Interconnect struct {
	// Enable or disable the application awareness feature on this Cloud Interconnect.
	// +kcc:proto:field=google.cloud.compute.v1beta.Interconnect.aai_enabled
	AaiEnabled *bool `json:"aaiEnabled,omitempty"`

	// Administrative status of the interconnect. When this is set to true, the Interconnect is functional and can carry traffic. When set to false, no packets can be carried over the interconnect and no BGP routes are exchanged over it. By default, the status is set to true.
	// +kcc:proto:field=google.cloud.compute.v1beta.Interconnect.admin_enabled
	AdminEnabled *bool `json:"adminEnabled,omitempty"`

	// Configuration information for application awareness on this Cloud Interconnect.
	// +kcc:proto:field=google.cloud.compute.v1beta.Interconnect.application_aware_interconnect
	...
	// +kcc:proto:field=google.cloud.compute.v1beta.Interconnect.available_features
	AvailableFeatures []string `json:"availableFeatures,omitempty"`

	// [Output Only] A list of CircuitInfo objects, that describe the individual circuits in this LAG.
	// +kcc:proto:field=google.cloud.compute.v1beta.Interconnect.circuit_infos
	CircuitInfos []InterconnectCircuitInfo `json:"circuitInfos,omitempty"`

	// [Output Only] Creation timestamp in RFC3339 text format.
	// +kcc:proto:field=google.cloud.compute.v1beta.Interconnect.creation_timestamp
	CreationTimestamp *string `json:"creationTimestamp,omitempty"`

	// Customer name, to put in the Letter of Authorization as the party authorized to request a crossconnect.
	// +kcc:proto:field=google.cloud.compute.v1beta.Interconnect.customer_name
	CustomerName *string `json:"customerName,omitempty"`

	// An optional description of this resource. Provide this property when you create the resource.
	// +kcc:proto:field=google.cloud.compute.v1beta.Interconnect.description
	Description *string `json:"description,omitempty"`

	// [Output Only] A list of outages expected for this Interconnect.
	// +kcc:proto:field=google.cloud.compute.v1beta.Interconnect.expected_outages
	ExpectedOutages []InterconnectOutageNotification `json:"expectedOutages,omitempty"`

	// [Output Only] IP address configured on the Google side of the Interconnect link. This can be used only for ping tests.
	// +kcc:proto:field=google.cloud.compute.v1beta.Interconnect.google_ip_address
	GoogleIPAddress *string `json:"googleIPAddress,omitempty"`

	// [Output Only] Google reference ID to be used when raising support tickets with Google or otherwise to debug backend connectivity issues.
	// +kcc:proto:field=google.cloud.compute.v1beta.Interconnect.google_reference_id
	GoogleReferenceID *string `json:"googleReferenceID,omitempty"`

	// [Output Only] The unique identifier for the resource. This identifier is defined by the server.
	// +kcc:proto:field=google.cloud.compute.v1beta.Interconnect.id
	ID *uint64 `json:"id,omitempty"`

	// [Output Only] A list of the URLs of all InterconnectAttachments configured to use this Interconnect.
	// +kcc:proto:field=google.cloud.compute.v1beta.Interconnect.interconnect_attachments
	...
	// +kcc:proto:field=google.cloud.compute.v1beta.Interconnect.interconnect_groups
	...
	// +kcc:proto:field=google.cloud.compute.v1beta.Interconnect.interconnect_type
	InterconnectType *string `json:"interconnectType,omitempty"`

	// [Output Only] Type of the resource. Always compute#interconnect for interconnects.
	// +kcc:proto:field=google.cloud.compute.v1beta.Interconnect.kind
	Kind *string `json:"kind,omitempty"`

	// A fingerprint for the labels being applied to this Interconnect, which is essentially a hash of the labels set used for optimistic locking. The fingerprint is initially generated by Compute Engine and changes after every request to modify or update labels. You must always provide an up-to-date fingerprint hash in order to update or change labels, otherwise the request will fail with error 412 conditionNotMet. To see the latest fingerprint, make a get() request to retrieve an Interconnect.
	// +kcc:proto:field=google.cloud.compute.v1beta.Interconnect.label_fingerprint
	LabelFingerprint *string `json:"labelFingerprint,omitempty"`

	// Labels for this resource. These can only be added or modified by the setLabels method. Each label key/value pair must comply with RFC1035. Label values may be empty.
	// +kcc:proto:field=google.cloud.compute.v1beta.Interconnect.labels
	...
	// +kcc:proto:field=google.cloud.compute.v1beta.Interconnect.link_type
	LinkType *string `json:"linkType,omitempty"`

	// URL of the InterconnectLocation object that represents where this connection is to be provisioned.
	// +kcc:proto:field=google.cloud.compute.v1beta.Interconnect.location
	...
	// +kcc:proto:field=google.cloud.compute.v1beta.Interconnect.macsec
	Macsec *InterconnectMacsec `json:"macsec,omitempty"`

	// Enable or disable MACsec on this Interconnect connection. MACsec enablement fails if the MACsec object is not specified.
	// +kcc:proto:field=google.cloud.compute.v1beta.Interconnect.macsec_enabled
	...
	// +kcc:proto:field=google.cloud.compute.v1beta.Interconnect.name
	Name *string `json:"name,omitempty"`

	// Email address to contact the customer NOC for operations and maintenance notifications regarding this Interconnect. If specified, this will be used for notifications in addition to all other forms described, such as Cloud Monitoring logs alerting and Cloud Notifications. This field is required for users who sign up for Cloud Interconnect using workforce identity federation.
	// +kcc:proto:field=google.cloud.compute.v1beta.Interconnect.noc_contact_email
	...
	// +kcc:proto:field=google.cloud.compute.v1beta.Interconnect.operational_status
	OperationalStatus *string `json:"operationalStatus,omitempty"`

	// [Output Only] IP address configured on the customer side of the Interconnect link. The customer should configure this IP address during turnup when prompted by Google NOC. This can be used only for ping tests.
	// +kcc:proto:field=google.cloud.compute.v1beta.Interconnect.peer_ip_address
	PeerIPAddress *string `json:"peerIPAddress,omitempty"`

	// [Output Only] Number of links actually provisioned in this interconnect.
	// +kcc:proto:field=google.cloud.compute.v1beta.Interconnect.provisioned_link_count
	ProvisionedLinkCount *int32 `json:"provisionedLinkCount,omitempty"`

	// Indicates that this is a Cross-Cloud Interconnect. This field specifies the location outside of Google's network that the interconnect is connected to.
	// +kcc:proto:field=google.cloud.compute.v1beta.Interconnect.remote_location
	...
	// +kcc:proto:field=google.cloud.compute.v1beta.Interconnect.requested_features
	RequestedFeatures []string `json:"requestedFeatures,omitempty"`

	// Target number of physical links in the link bundle, as requested by the customer.
	// +kcc:proto:field=google.cloud.compute.v1beta.Interconnect.requested_link_count
	RequestedLinkCount *int32 `json:"requestedLinkCount,omitempty"`

	// [Output Only] Reserved for future use.
	// +kcc:proto:field=google.cloud.compute.v1beta.Interconnect.satisfies_pzs
	SatisfiesPzs *bool `json:"satisfiesPzs,omitempty"`

	// [Output Only] Server-defined URL for the resource.
	// +kcc:proto:field=google.cloud.compute.v1beta.Interconnect.self_link
	SelfLink *string `json:"selfLink,omitempty"`

	// [Output Only] The current state of Interconnect functionality, which can take one of the following values: - ACTIVE: The Interconnect is valid, turned up and ready to use. Attachments may be provisioned on this Interconnect. - UNPROVISIONED: The Interconnect has not completed turnup. No attachments may be provisioned on this Interconnect. - UNDER_MAINTENANCE: The Interconnect is undergoing internal maintenance. No attachments may be provisioned or updated on this Interconnect.
	//  Check the State enum for the list of possible values.
	// +kcc:proto:field=google.cloud.compute.v1beta.Interconnect.state
	...
	// +kcc:proto:field=google.cloud.compute.v1beta.Interconnect.wire_groups
	WireGroups []string `json:"wireGroups,omitempty"`
}

// +kcc:proto=google.cloud.compute.v1beta.InterconnectApplicationAwareInterconnect
type InterconnectApplicationAwareInterconnect struct {
	// +kcc:proto:field=google.cloud.compute.v1beta.InterconnectApplicationAwareInterconnect.bandwidth_percentage_policy
	...
	// +kcc:proto:field=google.cloud.compute.v1beta.InterconnectApplicationAwareInterconnect.profile_description
	...
	// +kcc:proto:field=google.cloud.compute.v1beta.InterconnectApplicationAwareInterconnect.shape_average_percentages
	...
	// +kcc:proto:field=google.cloud.compute.v1beta.InterconnectApplicationAwareInterconnect.strict_priority_policy
	StrictPriorityPolicy *InterconnectApplicationAwareInterconnectStrictPriorityPolicy `json:"strictPriorityPolicy,omitempty"`
}

// +kcc:proto=google.cloud.compute.v1beta.InterconnectApplicationAwareInterconnectBandwidthPercentage
type InterconnectApplicationAwareInterconnectBandwidthPercentage struct {
	// Bandwidth percentage for a specific traffic class.
	// +kcc:proto:field=google.cloud.compute.v1beta.InterconnectApplicationAwareInterconnectBandwidthPercentage.percentage
	...
	// +kcc:proto:field=google.cloud.compute.v1beta.InterconnectApplicationAwareInterconnectBandwidthPercentage.traffic_class
	TrafficClass *string `json:"trafficClass,omitempty"`
}

// +kcc:proto=google.cloud.compute.v1beta.InterconnectApplicationAwareInterconnectBandwidthPercentagePolicy
type InterconnectApplicationAwareInterconnectBandwidthPercentagePolicy struct {
	...
	// +kcc:proto:field=google.cloud.compute.v1beta.InterconnectApplicationAwareInterconnectBandwidthPercentagePolicy.bandwidth_percentages
	BandwidthPercentages []InterconnectApplicationAwareInterconnectBandwidthPercentage `json:"bandwidthPercentages,omitempty"`
}

// +kcc:proto=google.cloud.compute.v1beta.InterconnectApplicationAwareInterconnectStrictPriorityPolicy
...
// +kcc:proto=google.cloud.compute.v1beta.NetworkAttachment
type NetworkAttachment struct {
	...
	// Name of the resource. Provided by the client when the resource is created. The name must be 1-63 characters long, and comply with RFC1035. Specifically, the name must be 1-63 characters long and match the regular expression `[a-z]([-a-z0-9]*[a-z0-9])?` which means the first character must be a lowercase letter, and all following characters must be a dash, lowercase letter, or digit, except the last character, which cannot be a dash.
	// +kcc:proto:field=google.cloud.compute.v1beta.NetworkAttachment.name
	Name *string `json:"name,omitempty"`
...
// +kcc:proto=google.cloud.compute.v1beta.NetworkEdgeSecurityService
type NetworkEdgeSecurityService struct {
	...
	// Name of the resource. Provided by the client when the resource is created. The name must be 1-63 characters long, and comply with RFC1035. Specifically, the name must be 1-63 characters long and match the regular expression `[a-z]([-a-z0-9]*[a-z0-9])?` which means the first character must be a lowercase letter, and all following characters must be a dash, lowercase letter, or digit, except the last character, which cannot be a dash.
	// +kcc:proto:field=google.cloud.compute.v1beta.NetworkEdgeSecurityService.name
	Name *string `json:"name,omitempty"`
