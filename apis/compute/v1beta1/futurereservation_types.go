...
// +kcc:spec:proto=google.cloud.compute.v1betabeta.FutureReservation
type ComputeFutureReservationSpec struct {
	...
	// +kcc:proto:field=google.cloud.compute.v1betabeta.FutureReservation.aggregate_reservation
	...
	// +kcc:proto:field=google.cloud.compute.v1betabeta.FutureReservation.auto_created_reservations_delete_time
	...
	// +kcc:proto:field=google.cloud.compute.v1betabeta.FutureReservation.auto_created_reservations_duration
	...
	// +kcc:proto:field=google.cloud.compute.v1betabeta.FutureReservation.auto_delete_auto_created_reservations
	AutoDeleteAutoCreatedReservations *bool `json:"autoDeleteAutoCreatedReservations"`

	// If not present, then FR will not deliver a new commitment or update an existing commitment.
	// +kcc:proto:field=google.cloud.compute.v1betabeta.FutureReservation.commitment_info
	...
	// +kcc:proto:field=google.cloud.compute.v1betabeta.FutureReservation.deployment_type
	DeploymentType *string `json:"deploymentType,omitempty"`

	// An optional description of this resource. Provide this property when you create the future reservation.
	// +kcc:proto:field=google.cloud.compute.v1betabeta.FutureReservation.description
	Description *string `json:"description,omitempty"`

	// Indicates if this group of VMs have emergent maintenance enabled.
	// +kcc:proto:field=google.cloud.compute.v1betabeta.FutureReservation.enable_emergent_maintenance
	...
	// +kcc:proto:field=google.cloud.compute.v1betabeta.FutureReservation.name
	Name *string `json:"name,omitempty"`

	// Name prefix for the reservations to be created at the time of delivery. The name prefix must comply with RFC1035. Maximum allowed length for name prefix is 20. Automatically created reservations name format will be -date-####.
	// +kcc:proto:field=google.cloud.compute.v1betabeta.FutureReservation.name_prefix
	...
	// +kcc:proto:field=google.cloud.compute.v1betabeta.FutureReservation.planning_status
	...
	// +kcc:proto:field=google.cloud.compute.v1betabeta.FutureReservation.reservation_mode
	...
	// +kcc:proto:field=google.cloud.compute.v1betabeta.FutureReservation.reservation_name
	...
	// +kcc:proto:field=google.cloud.compute.v1betabeta.FutureReservation.scheduling_type
	SchedulingType *string `json:"schedulingType,omitempty"`

	// List of Projects/Folders to share with.
	// +kcc:proto:field=google.cloud.compute.v1betabeta.FutureReservation.share_settings
	ShareSettings *ShareSettings `json:"shareSettings,omitempty"`

	// Indicates whether the auto-created reservation can be consumed by VMs with affinity for "any" reservation. If the field is set, then only VMs that target the reservation by name can consume from the delivered reservation.
	// +kcc:proto:field=google.cloud.compute.v1betabeta.FutureReservation.specific_reservation_required
	SpecificReservationRequired *bool `json:"specificReservationRequired,omitempty"`

	// Future Reservation configuration to indicate instance properties and total count.
	// +kcc:proto:field=google.cloud.compute.v1betabeta.FutureReservation.specific_sku_properties
	SpecificSkuProperties *FutureReservationSpecificSkuProperties `json:"specificSkuProperties,omitempty"`

	// Time window for this Future Reservation.
	// +kcc:proto:field=google.cloud.compute.v1betabeta.FutureReservation.time_window
...
// +kcc:observedstate:proto=google.cloud.compute.v1betabeta.FutureReservation
type ComputeFutureReservationObservedState struct {
	...
	// +kcc:proto:field=google.cloud.compute.v1betabeta.FutureReservationStatus.amendment_status
	AmendmentStatus *string `json:"amendmentStatus,omitempty"`

	// Fully qualified urls of the automatically created reservations at start_time.
	// +kcc:proto:field=google.cloud.compute.v1betabeta.FutureReservationStatus.auto_created_reservations
	...
	// +kcc:proto:field=google.cloud.compute.v1betabeta.FutureReservationStatus.existing_matching_usage_info
	...
	// +kcc:proto:field=google.cloud.compute.v1betabeta.FutureReservationStatus.fulfilled_count
	...
	// +kcc:proto:field=google.cloud.compute.v1betabeta.FutureReservationStatus.last_known_good_state
	...
	// +kcc:proto:field=google.cloud.compute.v1betabeta.FutureReservationStatus.lock_time
	LockTime *string `json:"lockTime,omitempty"`

	// Current state of this Future Reservation
	//  Check the ProcurementStatus enum for the list of possible values.
	// +kcc:proto:field=google.cloud.compute.v1betabeta.FutureReservationStatus.procurement_status
	ProcurementStatus *string `json:"procurementStatus,omitempty"`

	// +kcc:proto:field=google.cloud.compute.v1betabeta.FutureReservationStatus.specific_sku_properties
	...
	// +kcc:proto:field=google.cloud.compute.v1betabeta.FutureReservation.creation_timestamp
	CreationTimestamp *string `json:"creationTimestamp,omitempty"`

	// [Output Only] A unique identifier for this future reservation. The server defines this identifier.
	// +kcc:proto:field=google.cloud.compute.v1betabeta.FutureReservation.id
	ID *uint64 `json:"id,omitempty"`

	// [Output Only] Type of the resource. Always compute#futureReservation for future reservations.
	// +kcc:proto:field=google.cloud.compute.v1betabeta.FutureReservation.kind
	Kind *string `json:"kind,omitempty"`

	// [Output Only] Server-defined fully-qualified URL for this resource.
	// +kcc:proto:field=google.cloud.compute.v1betabeta.FutureReservation.self_link
	SelfLink *string `json:"selfLink,omitempty"`

	// [Output Only] Server-defined URL for this resource with the resource id.
	// +kcc:proto:field=google.cloud.compute.v1betabeta.FutureReservation.self_link_with_id
	SelfLinkWithID *string `json:"selfLinkWithID,omitempty"`

	// [Output Only] URL of the Zone where this future reservation resides.
	// +kcc:proto:field=google.cloud.compute.v1betabeta.FutureReservation.zone
