...
// +kcc:proto=google.cloud.compute.v1beta.SecurityPolicy
...
// +kcc:proto=google.cloud.compute.v1beta.SecurityPolicyAdvancedOptionsConfig
type SecurityPolicyAdvancedOptionsConfig struct {
	// Custom configuration to apply the JSON parsing. Only applicable when json_parsing is set to STANDARD.
	// +kcc:proto:field=google.cloud.compute.v1beta.SecurityPolicyAdvancedOptionsConfig.json_custom_config
	...
	// +kcc:proto:field=google.cloud.compute.v1beta.SecurityPolicyAdvancedOptionsConfig.json_parsing
	JsonParsing *string `json:"jsonParsing,omitempty"`

	// Check the LogLevel enum for the list of possible values.
	// +kcc:proto:field=google.cloud.compute.v1beta.SecurityPolicyAdvancedOptionsConfig.log_level
	LogLevel *string `json:"logLevel,omitempty"`

	// An optional list of case-insensitive request header names to use for resolving the callers client IP address.
	// +kcc:proto:field=google.cloud.compute.v1beta.SecurityPolicyAdvancedOptionsConfig.user_ip_request_headers
	UserIPRequestHeaders []string `json:"userIpRequestHeaders,omitempty"`
}

// +kcc:proto=google.cloud.compute.v1beta.SecurityPolicyAdvancedOptionsConfigJsonCustomConfig
type SecurityPolicyAdvancedOptionsConfigJsonCustomConfig struct {
	...
	// +required
	// +kcc:proto:field=google.cloud.compute.v1beta.SecurityPolicyAdvancedOptionsConfigJsonCustomConfig.content_types
	ContentTypes []string `json:"contentTypes,omitempty"`
}

type SecurityPolicyRecaptchaOptionsConfig struct {
	// +required
	// +kcc:proto:field=google.cloud.compute.v1beta.SecurityPolicyRecaptchaOptionsConfig.redirect_site_key
...
// +kcc:proto=google.cloud.compute.v1beta.SecurityPolicyRule
type SecurityPolicyRule struct {
	...
	// +required
	// +kcc:proto:field=google.cloud.compute.v1beta.SecurityPolicyRule.action
	Action *string `json:"action,omitempty"`

	// An optional description of this resource. Provide this property when you create the resource.
	// +kcc:proto:field=google.cloud.compute.v1beta.SecurityPolicyRule.description
	Description *string `json:"description,omitempty"`

	// Optional, additional actions that are performed on headers. This field is only supported in Global Security Policies of type CLOUD_ARMOR.
	// +kcc:proto:field=google.cloud.compute.v1beta.SecurityPolicyRule.header_action
	HeaderAction *SecurityPolicyRuleHTTPHeaderAction `json:"headerAction,omitempty"`

	// A match condition that incoming traffic is evaluated against. If it evaluates to true, the corresponding 'action' is enforced.
	// +required
	// +kcc:proto:field=google.cloud.compute.v1beta.SecurityPolicyRule.match
	Match *SecurityPolicyRuleMatcher `json:"match,omitempty"`

	// Preconfigured WAF configuration to be applied for the rule. If the rule does not evaluate preconfigured WAF rules, i.e., if evaluatePreconfiguredWaf() is not used, this field will have no effect.
	// +kcc:proto:field=google.cloud.compute.v1beta.SecurityPolicyRule.preconfigured_waf_config
	PreconfiguredWafConfig *SecurityPolicyRulePreconfiguredWafConfig `json:"preconfiguredWafConfig,omitempty"`

	// If set to true, the specified action is not enforced.
	// +kcc:proto:field=google.cloud.compute.v1beta.SecurityPolicyRule.preview
	Preview *bool `json:"preview,omitempty"`

	// An integer indicating the priority of a rule in the list. The priority must be a positive value between 0 and 2147483647. Rules are evaluated from highest to lowest priority where 0 is the highest priority and 2147483647 is the lowest priority.
	// +required
	// +kcc:proto:field=google.cloud.compute.v1beta.SecurityPolicyRule.priority
	Priority *int32 `json:"priority,omitempty"`

	// Must be specified if the action is "rate_based_ban" or "throttle". Cannot be specified for any other actions.
	// +kcc:proto:field=google.cloud.compute.v1beta.SecurityPolicyRule.rate_limit_options
	RateLimitOptions *SecurityPolicyRuleRateLimitOptions `json:"rateLimitOptions,omitempty"`

	// Parameters defining the redirect action. Cannot be specified for any other actions. This field is only supported in Global Security Policies of type CLOUD_ARMOR.
	// +kcc:proto:field=google.cloud.compute.v1beta.SecurityPolicyRule.redirect_options
	RedirectOptions *SecurityPolicyRuleRedirectOptions `json:"redirectOptions,omitempty"`
}

// +kcc:proto=google.cloud.compute.v1beta.SecurityPolicyRuleMatcher
type SecurityPolicyRuleMatcher struct {
	// The configuration options available when specifying versioned_expr. This field must be specified if versioned_expr is specified and cannot be specified if versioned_expr is not specified.
	// +kcc:proto:field=google.cloud.compute.v1beta.SecurityPolicyRuleMatcher.config
	...
	// +kcc:proto:field=google.cloud.compute.v1beta.SecurityPolicyRuleMatcher.expr
	...
	// +kcc:proto:field=google.cloud.compute.v1beta.SecurityPolicyRuleMatcher.versioned_expr
...
// +kcc:proto=google.cloud.compute.v1beta.SecurityPolicyRuleMatcherConfig
type SecurityPolicyRuleMatcherConfig struct {
	// CIDR IP address range. Maximum number of src_ip_ranges allowed is 10.
	// +required
	// +kcc:proto:field=google.cloud.compute.v1beta.SecurityPolicyRuleMatcherConfig.src_ip_ranges
	SrcIPRanges []string `json:"srcIpRanges,omitempty"`
}

// +kcc:proto=google.cloud.compute.v1beta.SecurityPolicyRuleRateLimitOptions
type SecurityPolicyRuleRateLimitOptions struct {
	// Can only be specified if the action for the rule is "rate_based_ban". If specified, determines the time (in seconds) the traffic will continue to be banned by the rate limit after the rate falls below the threshold.
	// +kcc:proto:field=google.cloud.compute.v1beta.SecurityPolicyRuleRateLimitOptions.ban_duration_sec
	BanDurationSec *int32 `json:"banDurationSec,omitempty"`

	// Can only be specified if the action for the rule is "rate_based_ban". If specified, the key will be banned for the configured 'ban_duration_sec' when the number of requests that exceed the 'rate_limit_threshold' also exceed this 'ban_threshold'.
	// +kcc:proto:field=google.cloud.compute.v1beta.SecurityPolicyRuleRateLimitOptions.ban_threshold
	BanThreshold *SecurityPolicyRuleRateLimitOptionsThreshold `json:"banThreshold,omitempty"`

	// Action to take for requests that are under the configured rate limit threshold. Valid option is "allow" only.
	// +required
	// +kcc:proto:field=google.cloud.compute.v1beta.SecurityPolicyRuleRateLimitOptions.conform_action
	...
	// +kcc:proto:field=google.cloud.compute.v1beta.SecurityPolicyRuleRateLimitOptions.enforce_on_key
	EnforceOnKey *string `json:"enforceOnKey,omitempty"`

	// If specified, any combination of values of enforce_on_key_type/enforce_on_key_name is treated as the key on which ratelimit threshold/action is enforced. You can specify up to 3 enforce_on_key_configs. If enforce_on_key_configs is specified, enforce_on_key must not be specified.
	// +kcc:proto:field=google.cloud.compute.v1beta.SecurityPolicyRuleRateLimitOptions.enforce_on_key_configs
	...
	// +kcc:proto:field=google.cloud.compute.v1beta.SecurityPolicyRuleRateLimitOptions.enforce_on_key_name
	...
	// +required
	// +kcc:proto:field=google.cloud.compute.v1beta.SecurityPolicyRuleRateLimitOptions.exceed_action
	ExceedAction *string `json:"exceedAction,omitempty"`

	// Parameters defining the redirect action that is used as the exceed action. Cannot be specified if the exceed action is not redirect. This field is only supported in Global Security Policies of type CLOUD_ARMOR.
	// +kcc:proto:field=google.cloud.compute.v1beta.SecurityPolicyRuleRateLimitOptions.exceed_redirect_options
	ExceedRedirectOptions *SecurityPolicyRuleRedirectOptions `json:"exceedRedirectOptions,omitempty"`

	// Threshold at which to begin ratelimiting.
	// +required
	// +kcc:proto:field=google.cloud.compute.v1beta.SecurityPolicyRuleRateLimitOptions.rate_limit_threshold
	RateLimitThreshold *SecurityPolicyRuleRateLimitOptionsThreshold `json:"rateLimitThreshold,omitempty"`
}

// +kcc:proto=google.cloud.compute.v1beta.SecurityPolicyRuleRateLimitOptionsThreshold
type SecurityPolicyRuleRateLimitOptionsThreshold struct {
	// Number of HTTP(S) requests for calculating the threshold.
	// +required
	// +kcc:proto:field=google.cloud.compute.v1beta.SecurityPolicyRuleRateLimitOptionsThreshold.count
	Count *int32 `json:"count,omitempty"`

	// Interval over which the threshold is computed.
	// +required
	// +kcc:proto:field=google.cloud.compute.v1beta.SecurityPolicyRuleRateLimitOptionsThreshold.interval_sec
	IntervalSec *int32 `json:"intervalSec,omitempty"`
}

// +kcc:proto=google.cloud.compute.v1beta.SecurityPolicyRuleRedirectOptions
type SecurityPolicyRuleRedirectOptions struct {
	// Target for the redirect action. This is required if the type is EXTERNAL_302 and cannot be specified for GOOGLE_RECAPTCHA.
	// +kcc:proto:field=google.cloud.compute.v1beta.SecurityPolicyRuleRedirectOptions.target
	...
	// +required
	// +kcc:proto:field=google.cloud.compute.v1beta.SecurityPolicyRuleRedirectOptions.type
	Type *string `json:"type,omitempty"`
}
...
// +kcc:observedstate:proto=google.cloud.compute.v1beta.SecurityPolicy
