...
// +kcc:spec:proto=google.cloud.compute.v1beta.Subnetwork
type ComputeSubnetworkSpec struct {
	// Immutable. An optional description of this resource. Provide this property when
	// you create the resource. This field can be set only at resource
	// creation time.
	// +kcc:proto:field=google.cloud.compute.v1beta.Subnetwork.description
	...
	// +required
	// +kcc:proto:field=google.cloud.compute.v1beta.Subnetwork.ip_cidr_range
	IPCIDRRange *string `json:"ipCidrRange,omitempty"`

	// The access type of IPv6 address this subnet holds. It's immutable and can only be specified during creation
	// or the first time the subnet is updated into IPV4_IPV6 dual stack. If the ipv6_type is EXTERNAL then this subnet
	// cannot enable direct path. Possible values: ["EXTERNAL", "INTERNAL"].
	// +kcc:proto:field=google.cloud.compute.v1beta.Subnetwork.ipv6_access_type
	...
	// +kcc:proto:field=google.cloud.compute.v1beta.Subnetwork.log_config
	...
	// +required
	// +kcc:proto:field=google.cloud.compute.v1beta.Subnetwork.network
	NetworkRef *ComputeNetworkRef `json:"networkRef"`

	// When enabled, VMs in this subnetwork without external IP addresses can
	// access Google APIs and services by using Private Google Access.
	// +kcc:proto:field=google.cloud.compute.v1beta.Subnetwork.private_ip_google_access
	PrivateIPGoogleAccess *bool `json:"privateIpGoogleAccess,omitempty"`

	// The private IPv6 google access type for the VMs in this
	// subnet.
	// +kcc:proto:field=google.cloud.compute.v1beta.Subnetwork.private_ipv6_google_access
	...
	// +kcc:proto:field=google.cloud.compute.v1beta.Subnetwork.purpose
	...
	// +kcc:proto:field=google.cloud.compute.v1beta.Subnetwork.role
	Role *string `json:"role,omitempty"`

	// +kcc:proto:field=google.cloud.compute.v1beta.Subnetwork.secondary_ip_ranges
	SecondaryIPRanges []SubnetworkSecondaryRange `json:"secondaryIpRange,omitempty"`

	// The stack type for this subnet to identify whether the IPv6 feature is enabled or not.
	// If not specified IPV4_ONLY will be used. Possible values: ["IPV4_ONLY", "IPV4_IPV6"].
	// +kcc:proto:field=google.cloud.compute.v1beta.Subnetwork.stack_type
	StackType *string `json:"stackType,omitempty"`
}

// ComputeSubnetworkStatus defines the config connector machine state of ComputeSubnetwork
// +kcc:status:proto=google.cloud.compute.v1beta.Subnetwork
type ComputeSubnetworkStatus struct {
	...
	// +kcc:proto:field=google.cloud.compute.v1beta.Subnetwork.creation_timestamp
	CreationTimestamp *string `json:"creationTimestamp,omitempty"`

	// The range of external IPv6 addresses that are owned by
	// this subnetwork.
	// +kcc:proto:field=google.cloud.compute.v1beta.Subnetwork.external_ipv6_prefix
	...
	// +kcc:proto:field=google.cloud.compute.v1beta.Subnetwork.fingerprint
	Fingerprint *string `json:"fingerprint,omitempty"`

	// The gateway address for default routes to reach destination addresses
	// outside this subnetwork.
	// +kcc:proto:field=google.cloud.compute.v1beta.Subnetwork.gateway_address
	GatewayAddress *string `json:"gatewayAddress,omitempty"`

	// The internal IPv6 address range that is assigned to this
	// subnetwork.
	// +kcc:proto:field=google.cloud.compute.v1beta.Subnetwork.internal_ipv6_prefix
	InternalIPV6Prefix *string `json:"internalIpv6Prefix,omitempty"`

	// The range of internal IPv6 addresses that are owned by
	// this subnetwork.
	// +kcc:proto:field=google.cloud.compute.v1beta.Subnetwork.ipv6_cidr_range
	IPV6CIDRRange *string `json:"ipv6CidrRange,omitempty"`

	// Server-defined URL for the resource.
	// +kcc:proto:field=google.cloud.compute.v1beta.Subnetwork.self_link
...
// +kcc:proto=google.cloud.compute.v1beta.SubnetworkLogConfig
type SubnetworkLogConfig struct {
	...
	// +kcc:proto:field=google.cloud.compute.v1beta.SubnetworkLogConfig.aggregation_interval
	AggregationInterval *string `json:"aggregationInterval,omitempty"`

	// Can only be specified if VPC flow logs for this subnetwork is enabled. The filter expression is used to define which VPC flow logs should be exported to Cloud Logging.
	// +kcc:proto:field=google.cloud.compute.v1beta.SubnetworkLogConfig.filter_expr
	FilterExpr *string `json:"filterExpr,omitempty"`

	// Can only be specified if VPC flow logging for this subnetwork is enabled. The value of the field must be in [0, 1]. Set the sampling rate of VPC flow logs within the subnetwork where 1.0 means all collected logs are reported and 0.0 means no logs are reported. Default is 0.5 unless otherwise specified by the org policy, which means half of all collected logs are reported.
	// +kcc:proto:field=google.cloud.compute.v1beta.SubnetworkLogConfig.flow_sampling
	FlowSampling *float32 `json:"flowSampling,omitempty"`

	// Can only be specified if VPC flow logs for this subnetwork is enabled. Configures whether all, none or a subset of metadata fields should be added to the reported VPC flow logs. Default is EXCLUDE_ALL_METADATA.
	//  Check the Metadata enum for the list of possible values.
	// +kcc:proto:field=google.cloud.compute.v1beta.SubnetworkLogConfig.metadata
	Metadata *string `json:"metadata,omitempty"`

	// Can only be specified if VPC flow logs for this subnetwork is enabled and "metadata" was set to CUSTOM_METADATA.
	// +kcc:proto:field=google.cloud.compute.v1beta.SubnetworkLogConfig.metadata_fields
	MetadataFields []string `json:"metadataFields,omitempty"`
}

// +kcc:proto=google.cloud.compute.v1beta.SubnetworkSecondaryRange
type SubnetworkSecondaryRange struct {
	// The range of IP addresses belonging to this subnetwork secondary range. Provide this property when you create the subnetwork. Ranges must be unique and non-overlapping with all primary and secondary IP ranges within a network. Only IPv4 is supported. The range can be any range listed in the Valid ranges list.
	// +required
	// +kcc:proto:field=google.cloud.compute.v1beta.SubnetworkSecondaryRange.ip_cidr_range
	IPCIDRRange *string `json:"ipCidrRange,omitempty"`

	// The name associated with this subnetwork secondary range, used when adding an alias IP range to a VM instance. The name must be 1-63 characters long, and comply with RFC1035. The name must be unique within the subnetwork.
	// +required
	// +kcc:proto:field=google.cloud.compute.v1beta.SubnetworkSecondaryRange.range_name
