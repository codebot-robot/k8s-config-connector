...
func EdgeCacheServiceSpec_ToProto(mapCtx *direct.MapContext, name string, in *krm.NetworkServicesEdgeCacheServiceSpec, resolve func(ref interface{}) string) *EdgeCacheService {
	...
	if in.EdgeSslCertificateRefs != nil {
		...
		for i, ref := range in.EdgeSslCertificateRefs {
			out.EdgeSslCertificates[i] = resolve(&ref)
		}
	}
...
func EdgeCacheServiceRouting_ToProto(mapCtx *direct.MapContext, in *krm.EdgecacheserviceRouting, resolve func(ref interface{}) string) *EdgeCacheRouting {
	if in == nil {
		return nil
	}
	...
	for i, v := range in.PathMatcher {
		out.PathMatchers[i] = EdgeCacheRoutingPathMatcher_ToProto(mapCtx, &v, resolve)
	}
	return out
}
...
func EdgeCacheRoutingPathMatcher_ToProto(mapCtx *direct.MapContext, in *krm.EdgecacheservicePathMatcher, resolve func(ref interface{}) string) *EdgeCacheRoutingPathMatcher {
	if in == nil {
		return nil
	}
	...
	for i, v := range in.RouteRule {
		out.RouteRules[i] = EdgeCacheRoutingRouteRule_ToProto(mapCtx, &v, resolve)
	}
	return out
}

func EdgeCacheRoutingRouteRule_ToProto(mapCtx *direct.MapContext, in *krm.EdgecacheserviceRouteRule, resolve func(ref interface{}) string) *EdgeCacheRoutingRouteRule {
	if in == nil {
		return nil
	}
...
func EdgeCacheRoutingRouteAction_ToProto(mapCtx *direct.MapContext, in *krm.EdgecacheserviceRouteAction, resolve func(ref interface{}) string) *EdgeCacheRoutingRouteAction {
	if in == nil {
		return nil
	}
	out := &EdgeCacheRoutingRouteAction{}
	out.CdnPolicy = EdgeCacheRoutingCdnPolicy_ToProto(mapCtx, in.CdnPolicy, resolve)
...
func EdgeCacheRoutingCdnPolicy_ToProto(mapCtx *direct.MapContext, in *krm.EdgecacheserviceCdnPolicy, resolve func(ref interface{}) string) *EdgeCacheRoutingCdnPolicy {
	if in == nil {
		return nil
	}
