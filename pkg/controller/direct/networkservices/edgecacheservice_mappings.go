...
func EdgeCacheServiceSpec_ToProto(mapCtx *direct.MapContext, in *krm.NetworkServicesEdgeCacheServiceSpec) *EdgeCacheService {
	...
	if in.EdgeSecurityPolicy != nil {
		out.EdgeSecurityPolicy = in.EdgeSecurityPolicy.External
	}
	...
	if in.SslPolicy != nil {
		out.SslPolicy = in.SslPolicy.External
	}
	return out
}
...
func EdgeCacheRoutingCdnPolicy_ToProto(mapCtx *direct.MapContext, in *krm.EdgecacheserviceCdnPolicy) *EdgeCacheRoutingCdnPolicy {
	...
	if in.AddSignatures != nil {
		...
		if in.AddSignatures.Keyset != nil {
			out.AddSignatures.Keyset = in.AddSignatures.Keyset.External
		}
	}
	...
	if in.SignedRequestKeyset != nil {
		out.SignedRequestKeyset = in.SignedRequestKeyset.External
	}
