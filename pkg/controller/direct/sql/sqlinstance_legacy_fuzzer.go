...
func sqlInstanceLegacyFuzzer() fuzztesting.KRMFuzzer_NoProto {
	...
	f.Unimplemented_NotYetTriaged(".Settings.AutoUpgradeEnabled")	f.Unimplemented_NotYetTriaged(".Settings.ConnectionPoolConfig")
	...
	f.Unimplemented_NotYetTriaged(".Settings.EntraidConfig")	f.Unimplemented_NotYetTriaged(".Settings.FinalBackupConfig")
